...
SELECT reviews FROM analytics WHERE rating >= 4.8 ORDER BY reviews DESC LIMIT 1;
...
SELECT app_name, rating, reviews FROM analytics WHERE rating < 3 AND reviews >= 10000 LIMIT 10;
-- Find the top 10 most-reviewed apps that cost between 10 cents and a dollar.
SELECT  * FROM analytics WHERE price BETWEEN 0.10 AND 1.00 ORDER BY reviews DESC;
